...
// Lab step icons
const BookTestIcon = () => (
  <div className="w-8 h-8 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-white/20 flex items-center justify-center">
...
const AppPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white pt-[70px] sm:pt-[80px] md:pt-[90px] lg:pt-[100px]">
      
      {/* Hero Section - Responsive */}
      <section className="w-full px-4 sm:px-6 md:px-8 lg:px-10 xl:px-[102px] pt-12 sm:pt-16 md:pt-20 lg:pt-24 xl:pt-[100px]">
        <div className="flex flex-col lg:flex-row justify-between items-center gap-6 sm:gap-8 lg:gap-12">
          <div className="w-full lg:w-[625px] text-center lg:text-left">
            <h1 className="font-bold text-[#21006C] text-3xl sm:text-4xl md:text-5xl lg:text-[52.66px] leading-tight lg:leading-[60px]">
              Where Care Meets <br className="hidden sm:block" />Convenience.
            </h1>
            <p className="text-[#21006C] text-sm sm:text-base md:text-lg lg:text-[20px] leading-relaxed lg:leading-[30px] mt-3 sm:mt-4">
              Your one-stop destination for all pharmaceutical needs. 
              We combine speed and safety to deliver medicines, supplements, & health essentials directly to you, making healthcare simple and stress-free.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start mt-6 sm:mt-8">
              <button onClick={handleDownload} className="text-white font-semibold rounded-full transition-all duration-200 hover:opacity-90 hover:-translate-y-0.5 px-6 py-2.5 sm:px-8 sm:py-3 w-full sm:w-auto bg-gradient-to-r from-[#9D77F2] to-[#7743ED]">
                Download app
              </button>
              <button className="border-2 border-purple-600 text-purple-600 font-semibold rounded-full hover:bg-purple-50 transition-all duration-200 px-6 py-2.5 sm:px-8 sm:py-3 w-full sm:w-auto">
                Fast. Secure. Verified.
              </button>
            </div>
          </div>
          <div className="w-full sm:max-w-[400px] md:max-w-[480px] lg:w-[544px] h-auto rounded-[30px] sm:rounded-[40px] overflow-hidden">
            <img src={appHeroImage} alt="App Hero" className="w-full h-full object-cover" />
          </div>
        </div>
      </section>
      ...
      <section className="w-full px-4 sm:px-6 md:px-8 lg:px-10 xl:px-[102px] mt-8 sm:mt-10 lg:mt-12">
        <div className="inline-flex items-center justify-center mb-4 sm:mb-6 py-1.5 px-4 sm:px-[22px] gap-[14px] rounded-[62px] bg-white shadow-[0px_0px_20px_rgba(119,67,237,0.2)] mx-auto lg:mx-0">
          <span className="text-purple-600 font-medium text-xs sm:text-sm">About us</span>
        </div>
        <div className="flex flex-col lg:flex-row justify-between gap-6 lg:gap-12">
      ...
      <section className="w-full px-4 sm:px-6 md:px-8 lg:px-10 xl:px-[102px] mt-12 lg:mt-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 lg:gap-8">
          {features.map((feature, index) => (
            <div key={index} className="bg-gradient-to-br from-purple-50 to-white rounded-xl sm:rounded-2xl p-5 sm:p-6 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="w-12 h-12 sm:w-14 sm:h-14 bg-purple-100 rounded-xl flex items-center justify-center mb-3 sm:mb-4 text-xl sm:text-2xl">
                {feature.icon}
              </div>
              <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-800 mb-2">{feature.title}</h3>
    ...
    >
      ...
      <section className="w-full px-4 sm:px-6 md:px-8 lg:px-10 xl:px-[102px] mt-16 lg:mt-24">
        <div className="w-full rounded-xl sm:rounded-2xl p-5 sm:p-8" style={{ border: '1px solid rgba(0,0,0,0.08)', background: 'linear-gradient(180deg, #f5f0ff 0%, #ffffff 100%)' }}>
          <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-800 mb-2 text-center">Why Choose Clynix?</h2>
          <p className="text-gray-500 text-xs sm:text-sm mb-6 sm:mb-8 text-center">
            We provide a seamless experience combining technology with expert healthcare knowledge.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {whyChooseFeatures.map((feature, index) => (
              <div key={index} className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-all">
                <feature.Icon />
                <h3 className="font-bold text-gray-800 mt-2 sm:mt-3 mb-1 text-xs sm:text-sm">{feature.title}</h3>
                <p className="text-gray-500 text-[10px] sm:text-xs leading-relaxed">{feature.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Lab Process Section - Responsive */}
      <section className="w-full mt-12 lg:mt-16" style={{ background: 'linear-gradient(246.65deg, #A177FF 15.99%, #6C36E7 52.88%)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-16 py-6 sm:py-8 lg:py-10">
          <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-8 lg:gap-4">
            {labProcessSteps.map((step, index) => (
              <div key={index} className="flex items-center gap-2 sm:gap-3">
                <div className="w-7 h-7 sm:w-9 sm:h-9 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0">
                  <span className="text-white font-bold text-xs sm:text-sm">{step.num}</span>
                </div>
                <div>
                  <div className="text-white font-bold text-xs sm:text-sm md:text-base">{step.title}</div>
                  <div className="text-purple-200 text-[10px] sm:text-xs">{step.desc}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* How to Order Section - Responsive */}
      <section className="w-full px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="max-w-[1330px] mx-auto rounded-[20px] border border-black/20 p-5 sm:p-8 lg:p-10" style={{ background: 'linear-gradient(180deg, #F5F0FF 0%, #FFFFFF 100%)' }}>
          <div className="text-center mb-8 sm:mb-10 lg:mb-12">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 mb-4">How to Order</h2>
            <div className="w-16 h-1 sm:w-20 bg-purple-600 mx-auto rounded-full"></div>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
            {/* Step cards */}
            <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 text-center hover:shadow-md transition-all">
              ...
              <div className="text-xl sm:text-2xl font-bold text-purple-600 mb-1 sm:mb-2">1</div>
              <h3 className="font-bold text-gray-800 text-sm sm:text-base mb-1 sm:mb-2">Upload</h3>
              <p className="text-gray-500 text-[11px] sm:text-xs">Snap a photo or upload a PDF of your doctor's prescription securely.</p>
            </div>
            <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 text-center hover:shadow-md transition-all">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-purple-100 rounded-xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <svg className="w-7 h-7 sm:w-8 sm:h-8 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-xl sm:text-2xl font-bold text-purple-600 mb-1 sm:mb-2">2</div>
              <h3 className="font-bold text-gray-800 text-sm sm:text-base mb-1 sm:mb-2">Verify</h3>
              <p className="text-gray-500 text-[11px] sm:text-xs">Our licensed pharmacists check the availability and dosage requirements.</p>
            </div>
            <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 text-center hover:shadow-md transition-all">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-purple-100 rounded-xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <svg className="w-7 h-7 sm:w-8 sm:h-8 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="font-bold text-gray-800 text-sm sm:text-base mb-1 sm:mb-2">Pay</h3>
              <p className="text-gray-500 text-[11px] sm:text-xs">Securely pay via multiple payment gateways including Credit Cards & Cash on Delivery.</p>
            </div>
            <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 text-center hover:shadow-md transition-all">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-purple-100 rounded-xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <svg className="w-7 h-7 sm:w-8 sm:h-8 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-xl sm:text-2xl font-bold text-purple-600 mb-1 sm:mb-2">4</div>
              <h3 className="font-bold text-gray-800 text-sm sm:text-base mb-1 sm:mb-2">Track</h3>
              <p className="text-gray-500 text-[11px] sm:text-xs">Watch your delivery reach you in real-time with our live tracker.</p>
            </div>
          </div>
        </div>
      </section>

      {/* Certified Pharmacy Network Section - Responsive */}
      <section className="w-full px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="max-w-[1216px] mx-auto flex flex-col lg:flex-row gap-8 lg:gap-12 xl:gap-[48px]">
          <div className="w-full lg:w-[584px] relative">
            <div className="relative rounded-2xl overflow-hidden shadow-lg h-[350px] sm:h-[400px] md:h-[450px] lg:h-[500px]">
              <img src={bottomImage} alt="Pharmacy Network" className="w-full h-full object-cover" />
              <div className="absolute bottom-3 left-1/2 -translate-x-1/2 w-[90%] sm:w-[400px] md:w-[500px] lg:w-[536px] bg-white/90 backdrop-blur-md rounded-xl p-4 sm:p-6 shadow-lg border-t border-white/20">
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="font-semibold text-gray-900 text-sm sm:text-base">Certified Partner</h4>
                    <p className="text-gray-500 text-xs sm:text-sm">1000+ trusted pharmacies</p>
                  </div>
          ...
          <div className="w-full lg:w-[584px] flex flex-col gap-4 sm:gap-6">
            <h3 className="text-2xl sm:text-3xl font-bold text-gray-900">Certified Pharmacy Network</h3>
            <p className="text-gray-600 text-sm sm:text-base lg:text-lg leading-relaxed">
              Clynix connects you with a vast network of accredited and trusted local pharmacies. 
              Every partner is strictly vetted to ensure they maintain the highest standards of storage and pharmacological ethics.
            </p>
            <div className="space-y-3">
              <div className="bg-blue-50/50 rounded-xl p-3 sm:p-4 flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-800 text-sm sm:text-base">100% Authentic Medicines</h4>
                  <p className="text-gray-500 text-xs sm:text-sm">Direct sourcing from authorized distributors ensures zero counterfeit risk.</p>
                </div>
              </div>
              <div className="bg-blue-50/50 rounded-xl p-3 sm:p-4 flex items-start gap-3 sm:gap-4">
                <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div>
                  <h4 className="font-semibold text-gray-800 text-sm sm:text-base">Cold-Chain Management</h4>
                  <p className="text-gray-500 text-xs sm:text-sm">Insulin and other temperature-sensitive medicines are delivered in cooling kits.</p>
                </div>
              </div>
              <div className="bg-blue-50/50 rounded-xl p-3 sm:p-4 flex items-start gap-3 sm:gap-4">
                <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div>
                  <h4 className="font-semibold text-gray-800 text-sm sm:text-base">Digital Prescription Records</h4>
                  <p className="text-gray-500 text-xs sm:text-sm">We store your prescriptions digitally for easy re-ordering and tracking.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="w-full px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="max-w-[768px] mx-auto">
          <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 text-center mb-6 sm:mb-8">Frequently Asked Questions</h3>
          <div className="space-y-3">
            <div className="bg-[#F5F6FA] rounded-xl border border-gray-200 overflow-hidden">
              <button className="w-full px-4 sm:px-6 py-3 sm:py-4 text-left flex justify-between items-center hover:bg-gray-100 transition-colors"
                onClick={(e) => {
                  const answer = e.currentTarget.nextElementSibling;
                  const icon = e.currentTarget.querySelector('svg');
                  answer.classList.toggle('hidden');
                ...
                <span className="font-medium text-gray-800 text-sm sm:text-base">Is a prescription mandatory for all medicines?</span>
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-gray-500 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </button>
              <div className="hidden px-4 sm:px-6 pb-3 sm:pb-4">
                <p className="text-gray-600 text-xs sm:text-sm">Yes, prescription is mandatory for all prescription medicines. Over-the-counter medicines can be purchased without prescription.</p>
              </div>
            </div>
            <div className="bg-[#F5F6FA] rounded-xl border border-gray-200 overflow-hidden">
              <button className="w-full px-4 sm:px-6 py-3 sm:py-4 text-left flex justify-between items-center hover:bg-gray-100 transition-colors"
                ...
                <span className="font-medium text-gray-800 text-sm sm:text-base">How long does the delivery usually take?</span>
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-gray-500 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </button>
              <div className="hidden px-4 sm:px-6 pb-3 sm:pb-4">
                <p className="text-gray-600 text-xs sm:text-sm">Delivery usually takes 10-20 minutes in major city areas, and 1-2 days for other locations.</p>
              </div>
            </div>
            <div className="bg-[#F5F6FA] rounded-xl border border-gray-200 overflow-hidden">
              <button className="w-full px-4 sm:px-6 py-3 sm:py-4 text-left flex justify-between items-center hover:bg-gray-100 transition-colors"
                ...
                <span className="font-medium text-gray-800 text-sm sm:text-base">Do you accept medical insurance?</span>
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-gray-500 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </button>
              <div className="hidden px-4 sm:px-6 pb-3 sm:pb-4">
                <p className="text-gray-600 text-xs sm:text-sm">Yes, we accept major medical insurance providers. Please contact our support for more details.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="w-full px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="max-w-[1001px] mx-auto flex flex-col lg:flex-row gap-8 lg:gap-12 xl:gap-[93px]">
          
          {/* Left Side - Contact Info */}
          <div className="w-full lg:w-[426px] space-y-4 sm:space-y-6">
            <div className="text-center lg:text-left">
            ...
            <div className="space-y-3 sm:space-y-4 pt-2 sm:pt-4">
              <div className="flex items-center gap-3 sm:gap-4 p-2 sm:p-3 bg-gray-50 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-gray-800 font-medium text-xs sm:text-sm">simcurarx@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 sm:gap-4 p-2 sm:p-3 bg-gray-50 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-gray-800 font-medium text-xs sm:text-sm">Indrapalem, Kakinada, Andhra Pradesh 533006</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 sm:gap-4 p-2 sm:p-3 bg-gray-50 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-gray-800 font-medium text-xs sm:text-sm">+91 6300 778 241</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-[481px]">
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
              <div>
                ...
                <input type="text" required value={formData.name} onChange={(e) => setFormData({...formData, name: e.target.value})}
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition text-sm"
                  placeholder="Your full name" />
              </div>
              <div>
              ...
              <div>
                ...
                <textarea rows={3} required value={formData.message} onChange={(e) => setFormData({...formData, message: e.target.value})}
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition resize-none text-sm"
                  placeholder="Tell us about your project..." />
              </div>
              <button type="submit" className="w-full py-2.5 sm:py-3 bg-purple-600 text-white font-semibold rounded-xl hover:bg-purple-700 transition-all duration-200 shadow-md hover:shadow-lg text-sm sm:text-base">
                Submit
              </button>
            </form>
          </div>
      ...
      {/* Footer - Responsive (keeping existing footer as is - already responsive) */}
       {/* Footer */}
      <footer className="bg-gray-900 text-white mt-16">
        <div className="max-w-[1272px] mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
