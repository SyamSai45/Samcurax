          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-8">
            ...
            <div className="flex-1 bg-white rounded-2xl border border-gray-200 shadow-md p-8 md:p-10">
              ...
              <form className="space-y-4">
                ...
                <button
                  type="button"
                  className="w-full py-3.5 bg-gradient-to-r from-blue-700 to-purple-700 text-white text-sm font-semibold rounded-lg flex items-center justify-center gap-2 transition-all duration-200 hover:opacity-90 hover:-translate-y-0.5"
                >
                  Send Message
